...
<head>
    ...
    <title>Kermesse | Modificar Rol</title>
                                ...
                                <form method="POST" action="../../negocio/ng_rol.php">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input type="text" value="<?php echo $rol->__GET('id_rol'); ?>" class="form-control" id="id_rol" name="id_rol" maxlength="45" readonly>
                                            <input type="hidden" name="txtaccion" value="2" id="txtaccion" />
                                        </div>

                                        <div class="form-group">
                                            <label>Descripción del rol</label>
                                            <input type="text" value="<?php echo $rol->__GET('rol_descripcion'); ?>" class="form-control" id="rol_descripcion" name="rol_descripcion" maxlength="70" required>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
