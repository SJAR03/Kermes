...
<head>
  ...
  <title>AdminLTE 3 | Registro de denominación</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Registrar denominación</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Registrar denominación</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../../negocio/ng_denominacion.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>Valor</label>
                      <input type="text" class="form-control" id="valor" name="valor" maxlength="45" placeholder="Valor" title="Ingrese el valor de la moneda" required>
                    </div>
