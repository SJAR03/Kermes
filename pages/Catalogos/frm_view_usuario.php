...
if (isset($varIdUsuario)) {
    $varIdUsuario = $_GET['vieUsu'];
}

// Datos del país para ver
$usuario = $dtu->getUsuario($varIdUsuario);
...
<head>
    ...
    <title>Kermesse | Visualizar Usuarios</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Visualizar Usuario - <?php echo $usuario->__GET('usuario');  ?></h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><?php echo $usuario->__GET('usuario');  ?></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $usuario->__GET('usuario');  ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="../../negocio/ng_usuario.php">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $usuario->__GET('id_usuario'); ?>" class="form-control" id="id_usuario" name="id_usuario" maxlength="45" disabled>
                                            <input type="hidden" name="txtaccion" value="2" id="txtaccion" />
                                        </div>
                                        <div class="form-group">
                                            <label>Usuario:</label>
                                            <input type="text" value="<?php echo $usuario->__GET('usuario'); ?>" class="form-control" id="user_usuario" name="usuario" maxlength="15" placeholder="Ingrese nombre del nuevo Usuario" title="Ingrese nombre del nuevo Usuario" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombres: </label>
                                            <input type="text" value="<?php echo $usuario->__GET('nombres'); ?>" class="form-control" id="user_nombres" name="nombres" maxlength="45" placeholder="Ingrese sus nombres" title="Ingrese sus nombres" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Apellidos: </label>
                                            <input type="text" value="<?php echo $usuario->__GET('apellidos'); ?>" class="form-control" id="user_apellidos" name="apellidos" maxlength="45" placeholder="Ingrese sus apellidos" title="Ingrese sus apellidos" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Email: </label>
                                            <input type="text" value="<?php echo $usuario->__GET('email'); ?>" class="form-control" id="user_email" name="email" maxlength="45" placeholder="Ingrese su correo electrónico" title="Ingrese su correo electrónico" required disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Contraseña: </label>
                                            <input type="text" value="<?php echo $usuario->__GET('pwd'); ?>" class="form-control" id="user_contra" name="contraseña" maxlength="45" placeholder="Ingrese una contraseña" title="Ingrese una contraseña" required disabled>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
