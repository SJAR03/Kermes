...
<head>
  ...
  <title>AdminLTE 3 | Registrar Parroquia</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Nuevo ingreso de Parroquia</h1>
            </div>
            <div class="col-sm-6">
                ...
                <form method="POST" action="../../negocio/ng_parroquia.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Ingrese la dirección" title="Ingrese la dirección" required>
                    </div>

                    <div class="form-group">
                      <label>Télefono</label>
                      <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Ingrese el télefono" title="Ingrese el télefono" required>
                    </div>

                    <div class="form-group">
                      <label>Párroco</label>
                      <input type="text" class="form-control" id="parroco" name="parroco" placeholder="Ingrese el nombre del Párroco" title="Ingrese el nombre del Párroco" required>
                    </div>

                    <div class="form-group">
                      <label>Logo</label>
                      <input type="text" class="form-control" id="logo" name="logo" placeholder="Ingrese el logo" title="Ingrese el logo" required>
                    </div>

                    <div class="form-group">
                      <label>Sitio web</label>
                      <input type="text" class="form-control" id="sitio_web" name="sitio_web" placeholder="Ingrese el logo" title="Ingrese el logo" required>
                    </div>
