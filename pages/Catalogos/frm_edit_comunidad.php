...
if (isset($varIdComu)) {
  $varIdComu = $_GET['editCom']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR LA COMUNIDAD
}
                ...
                <form method="POST" action="../../negocio/ng_Comunidad.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="desc_contribucion" name="desc_contribucion" maxlength="100" placeholder="Ingrese la descripcion de la contribucion" title="Ingrese la descripcion de la contribucion" required>
                    </div>
