...
if (isset($varIdCB)) {
  $varIdCB = $_GET['editCB']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR LA COMUNIDAD
}
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar Control de Bonos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Editar Control de Bonos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar Control de Bonos</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="../../negocio/ng_Control_Bonos.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Valor</label>
                    <input type="float" class="form-control" id="valor" name="valor" placeholder="Ingrese el valor" title="Ingrese el valor" required>
                  </div>
