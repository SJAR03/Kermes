...
<head>
    ...
    <title>KERMESSE | Tabla Rol</title>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabla Roles</h3>
                        </div>

                        <div class="card-body">
                            <div class="form-group col-md-12" style="text-align: right;">
                                <a href="frm_rol.php" title="Registrar un nuevo rol" target="blank">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($dtr->listarVw_Rol() as $r) :
                                    ?>
                                        <tr>
                                            <td><?php echo $r->__GET('id_rol'); ?></td>
                                            <td><?php echo $r->__GET('rol_descripcion'); ?></td>
                                            <td>
                                                <a href="frm_edit_rol.php?editRol=<?php echo $r->__GET('id_rol') ?>"><i class="far fa-edit fa-2x" title="Editar rol"></i></a>
                                                <a href="frm_view_rol.php?vieRol=<?php echo $r->__GET('id_rol') ?>"><i class="far fa-eye fa-2x" title="Visualizar rol"></i></a>
                                                <a href="#" onclick="deleteRol(<?php echo $r->__GET('id_rol') ?>);"><i class="far fa-2x fa-trash-alt" title="Eliminar rol"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    endforeach;
        ...
        <script>
            function deleteRol(idR) {
                confirm(function(e, btn) {
                        e.preventDefault();
                        window.location.href = "../../negocio/ng_rol.php?delRol=" + idR;
                    },
                    function(e, btn) {
                        e.preventDefault();
                    });
