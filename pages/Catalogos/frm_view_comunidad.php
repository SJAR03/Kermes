...
if (isset($varIdComu)) {
  $varIdComu = $_GET['viewCom']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA VISUALIZAR LA COMUNIDAD
}

//OBTENEMOS LOS DATOS DE LA COMUNIDAD PARA SER EDITADO
$Comu = $dtComu->getComunidad($varIdComu);
...
<head>
  ...
  <title>AdminLTE 3 | Comunidad</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Visualizar datos de la Comunidad</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item active">Visualizar Comunidad</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Visualizar Comunidad</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../../negocio/ng_Comunidad.php">
                  <div class="card-body">
                    <div class="form-group">
                      <label>Nombre</label>
                      <input type="text" value="<?php echo $Comu->__GET('nombre') ?>" class="form-control" id="nombre" name="nombre" maxlength="45" placeholder="Ingrese nombre" title="Ingrese nombre" disabled>
                      <input type="hidden" value="2" name="txtaccion" id="txtaccion" />
                    </div>

                    <div class="form-group">
                      <label>Responsable</label>
                      <input type="text" class="form-control" id="responsable" name="responsable" maxlength="45" placeholder="Ingrese el nombre del responsable" title="Ingrese el nombre del responsable" disabled>
                    </div>

                    <div class="form-group">
                      <label>Descripcion de la Contribucion</label>
                      <input type="text" class="form-control" id="desc_contribucion" name="desc_contribucion" maxlength="100" placeholder="Ingrese la descripcion de la contribucion" title="Ingrese la descripcion de la contribucion" disabled>
                    </div>
                  ...
                  <div class="card-footer" style="text-align: center;">
                    ...
                    <a href="tbl_comunidad.php" title="Regresar a la página anterior"><i class="fas fa-2x fa-undo-alt"></i></a>
