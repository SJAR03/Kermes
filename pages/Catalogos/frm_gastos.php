                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id= "id_categoria_gastos" name="id_categoria_gastos" required>
                      ...
                      <tr>
                        <option value="<?php echo $r->__GET('id_categoria_gastos'); ?>"><?php echo $r->__GET('nombre'); ?></option>
                      </tr>
                      <?php endforeach; ?>
                    </select>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fechaGasto" name="fechaGasto" placeholder="Ingrese fecha de creacion" title="Ingrese fecha de creacion" required>
                  </div>
                  ...
                  <div class="form-group">
                    <label >Fechas de Edición Usuario</label>
                  ...
                  <div class="form-group">
                    <label >Eliminación Usuarios</label>
                  ...
                  <div class="form-group">
                    <label >Fechas de Eliminación Usuario</label>
