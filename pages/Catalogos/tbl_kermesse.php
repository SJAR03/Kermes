...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                ...
                                <tbody>
                                    <?php foreach ($K->listaKerm() as $r) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="frm_edit_kermesse.php?editKe=<?php echo $r->__GET('id_kermesse') ?>"><i class="far fa-edit fa-2x"></i></a>
                                                <a href="frm_view_kermesse.php?viewKe=<?php echo $r->__GET('id_kermesse') ?>"><i class="far fa-eye fa-2x"></i></a>
                                                <a href="#" onclick="eliminarKermesse(<?php echo $r->__GET('id_kermesse') ?>)"><i class="far fa-2x fa-trash-alt" title="Eliminar kermesse"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
        ...
        <script>
            function eliminarKermesse(ek) {
                confirm(function(e, btn) {
                        e.preventDefault();
                        window.location.href = "../../negocio/ng_kermesse.php?delK=" + ek;
                    },
                    function(e, btn) {
                        e.preventDefault();
                    });
