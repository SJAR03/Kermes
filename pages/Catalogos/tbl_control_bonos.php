...
<head>
    ...
    <title>Kermesse | Control Bonos</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Control Bonos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Control Bonos registrados</h3>
                        </div>

                        <div class="card-body">
                            <div class="form group col-md-12" style="text-align: right;">
                                <a href="frm_control_bonos.php" title="Resgistrar un nuevo control de bonos" target="_blank"><i class="far fa-2x fa-plus-square"></i></a>
                            </div>
