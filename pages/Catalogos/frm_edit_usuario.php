                                ...
                                <form method="POST" action="../../negocio/ng_usuario.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $usuario->__GET('usuario');; ?>" class="form-control" id="usuario" name="usuario" maxlength="45" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input type="text" value="<?php echo $usuario->__GET('nombres'); ?>" class="form-control" id="nombres" name="nombres" maxlength="45" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Apellidos</label>
                                            <input type="text" value="<?php echo $usuario->__GET('apellidos'); ?>" class="form-control" id="apellidos" name="apellidos" maxlength="45" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" value="<?php echo $usuario->__GET('email'); ?>" class="form-control" id="email" name="email" maxlength="45" required>
                                        </div>
