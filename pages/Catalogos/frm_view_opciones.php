...
if (isset($varIdOpc)) {
    $varIdOpc = $_GET['vieOpc'];
}

// Datos de la opción para ver
$opc = $dto->getOpcion($varIdOpc);
...
<head>
    ...
    <title>Kermesse | Visualizar Opciones</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Visualizar Opción</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="../../negocio/ng_opciones.php">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $opc->__GET('id_opciones'); ?>" class="form-control" id="id_opciones" name="id_opciones" maxlength="45" disabled>
                                            <input type="hidden" name="txtaccion" value="2" id="txtaccion" />
                                        </div>
                                        <div class="form-group">
                                            <label>Descripción de la Opción</label>
                                            <input type="text" value="<?php echo $opc->__GET('opcion_descripcion'); ?>" class="form-control" id="opcion_descripcion" name="opcion_descripcion" maxlength="70" placeholder="Ingrese la descripción de la Opción" title="Ingrese la descripción de la Opción" required disabled>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
